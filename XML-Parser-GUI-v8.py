            ...
            for x in all:
                if x == 'inherited':
                    if root.getroot()[0].attrib['inherited'] !='':
                        print("inital inherited  ",root.getroot()[0].attrib['inherited'])
                        #updatedinherited=""
                        #updatedinherited=modify(root.getroot()[0].attrib['inherited'])
                        print(modify(root.getroot()[0].attrib['inherited']))
                        #root.getroot()[0].attrib['inherited']=updatedinherited
                        updatedinherited=modify(root.getroot()[0].attrib['inherited']) #main
                        print('updated inherited ',updatedinherited)
                        #root.getroot()[0].attrib['inherited']=updatedinherited
